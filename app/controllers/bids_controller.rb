  ...
  def make_bid_offer_trade(bid)
    ...
    begin
      ActiveRecord::Base.transaction do
        ...
        transactionlog = tradeLog.create_transaction_log!(amount: amount_paid, transaction_type: TransactionLog::TransactionType::FROM_WALLET, transaction_status: TransactionLog::TransactionStatus::SUCCESS,  user_id: bid.user.id)
